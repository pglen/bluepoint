...
function display_time_in_status_line(Status)

{
    //console.log("stat")
    if (Status)
        defaultStatus = document.getElementById(Status)
    ...
    defaultStatus.innerHTML = 'Encryption test form for BluePoint (C) ' + t;

    // Arrange to do it all again
